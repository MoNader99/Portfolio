    ...
    <div className='about-section '>
        <div className='container d-flex justify-content-center align-items-center'>
            <div class="hero-main row">
                <div class="hero-text col-md-7 ">
                    ...
                    <p>Hi, I'm Mohammed Nader. A passionate Software Developer based in New Cairo, Egypt. 📍</p>
                    <span>
        ...
        <div class="skills">
            ...
            <ul>
                ...
                <li>
                    <img src="https://www.vectorlogo.zone/logos/jestjsio/jestjsio-icon.svg" title="Jest" alt="Jest"/>
                </li>
                <li>
